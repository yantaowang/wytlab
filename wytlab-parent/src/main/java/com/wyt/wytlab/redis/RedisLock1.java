...
public class RedisLock1 {
     ...
     */
    public RedisLock1(RedisTemplate<String, Object> redisTemplate, String lockKey) {
     ...
     */
    public RedisLock1(RedisTemplate<String, Object> redisTemplate, String lockKey, int expireTime) {
     ...
     */
    public RedisLock1(RedisTemplate<String, Object> redisTemplate, String lockKey, long timeOut) {
        this(redisTemplate, lockKey);
     ...
     * @param timeOut       请求锁的超时时间(单位：毫秒)
     */
    public RedisLock1(RedisTemplate<String, Object> redisTemplate, String lockKey, int expireTime, long timeOut) {
        ...
        return (String) redisTemplate.execute(new RedisCallback<String>() {
            ...
            public String doInRedis(RedisConnection connection) throws DataAccessException {
                ...
                if (nativeConnection instanceof JedisCommands) {
                    result = ((JedisCommands) nativeConnection).set(key, value, SetParams.setParams().nx().px(1000l));
                }
